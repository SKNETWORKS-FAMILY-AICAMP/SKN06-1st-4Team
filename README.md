...
> 
유경상
> 수업을 배우는 과정에서는 크게 어려움이 없었다고 판단되었는데 막상 직접 코드를 작성해보니 생각이 안나고 적용이되지않아 많이 어려움을 겪었다.
> 처음 크롤링 과정에서부터 난관이 많았지만 프로젝트를 통해 수업 중 배운 내용들을 한번 더 정리해보고 공부하는 시간이 되어 좋았다.
> 
전하연
